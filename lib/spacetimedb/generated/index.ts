...
const tablesSchema = __schema({
  game_move: __table({
    name: 'game_move',
    indexes: [
      { accessor: 'id', name: 'game_move_id_idx_btree', algorithm: 'btree', columns: [
        'id',
      ] },
      { accessor: 'lobby_id', name: 'game_move_lobby_id_idx_btree', algorithm: 'btree', columns: [
        'lobbyId',
      ] },
    ],
    constraints: [
  ...
  game_state: __table({
    name: 'game_state',
    indexes: [
      { accessor: 'lobby_id', name: 'game_state_lobby_id_idx_btree', algorithm: 'btree', columns: [
        'lobbyId',
      ] },
    ],
    constraints: [
  ...
  lobby_player: __table({
    name: 'lobby_player',
    indexes: [
      { accessor: 'id', name: 'lobby_player_id_idx_btree', algorithm: 'btree', columns: [
        'id',
      ] },
      { accessor: 'lobby_id', name: 'lobby_player_lobby_id_idx_btree', algorithm: 'btree', columns: [
        'lobbyId',
      ] },
    ],
    constraints: [
...
const reducersSchema = __reducers(
  __reducerSchema("claim_timeout", ClaimTimeoutReducer),
  __reducerSchema("confirm_deposit", ConfirmDepositReducer),
  ...
  __reducerSchema("make_move", MakeMoveReducer),
