    ...
    <div className="space-y-4">
      ...
      <div className="space-y-2">
        ...
        <div className="flex gap-2">
          <button
            onClick={() => setSelectedChain(CHAIN_IDS.BASE)}
            className={`flex-1 px-4 py-3 rounded-xl font-bold text-sm transition-all flex items-center justify-center gap-2 ${selectedChain === CHAIN_IDS.BASE
          ...
          <button
            onClick={() => setSelectedChain(CHAIN_IDS.ARBITRUM)}
            className={`flex-1 px-4 py-3 rounded-xl font-bold text-sm transition-all flex items-center justify-center gap-2 ${selectedChain === CHAIN_IDS.ARBITRUM
              ? 'bg-blue-500 text-white shadow-lg shadow-blue-500/25'
              : 'bg-slate-100 text-slate-600 hover:bg-slate-200'
              }`}
          >
